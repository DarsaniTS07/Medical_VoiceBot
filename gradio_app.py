...
def process_inputs(audio_filepath, image_filepath):
    ...
    # Save audio with relative path in current directory
    output_audio = "doctor_response.mp3"
    voice_of_doctor = text_to_speech_with_elevenlabs(input_text=doctor_response, output_filepath=output_audio) 
